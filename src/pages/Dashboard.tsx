  ...
  return <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard 
          ...
          value={isLoading ? "Loading..." : stats?.availableRooms?.toString() || "0"} 
        ...
        <StatCard 
          ...
          value={isLoading ? "Loading..." : stats?.todayCheckIns?.toString() || "0"} 
        ...
        <StatCard 
          ...
          value={isLoading ? "Loading..." : stats?.todayCheckOuts?.toString() || "0"} 
        ...
        <StatCard 
          ...
          value={isLoading ? "Loading..." : `${Math.round(stats?.occupancyRate || 0)}%`} 
          trend="up" 
